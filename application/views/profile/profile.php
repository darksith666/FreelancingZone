            ...
            <div class="white-box">
              <div class="profile-widget">
                  ...
                  <div class="profile-btn">
                      <a href="/profile/edit" class="btn btn-default btn-outline m-r-0"><i class="fa fa-edit"></i> Edit my profile</a>
                      <?php if ($profile["email_verified"] != "YES") { ?>
                      <input type="hidden" name="action" value="validate_email">
                      <button type="submit" class="btn btn-default btn-outline m-r-0"><i class="fa fa-envelope-o"></i> Validate my email</button>
                      <?php } ?>
                  </div>
                </form>
              </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-xs-6 b-r"> <strong>Email</strong>
                            ...
                            if ($profile["email_visibility"]=="PUBLIC") {
                              echo $profile["email"].' (<span class="text-success">Public</span>)';
                            } else {
                              echo $profile["email"].' (<span class="text-warning">Hidden</span>)';
                            }
                            ?></p>
                        </div>
